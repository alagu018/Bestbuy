...
public class Utilities {
	...
	public String[][] readExcel(String excelFile, int  excelSheet) throws IOException {
		XSSFWorkbook book = new XSSFWorkbook("C:\\Users\\jai\\eclipse-workspace\\Bestbuy\\Data\\"+excelFile+".xlsx");  
		...
		String path = "C:\\Users\\jai\\eclipse-workspace\\Bestbuy\\snap\\"+test+ranNum+".png";
